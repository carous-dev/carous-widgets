...
```text
/widgets/ai-chat/latest/ai-chat.js
```

Local test URL:

```text
http://widgets.carous.test/widgets/ai-chat/latest/ai-chat.js
```
...
```html
<script
  src="http://widgets.carous.test/widgets/ai-chat/latest/ai-chat.js"
