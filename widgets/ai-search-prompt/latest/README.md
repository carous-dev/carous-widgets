...
```text
/widgets/ai-search-prompt/latest/ai-search-prompt.js
```

Local test URL:

```text
http://widgets.carous.test/widgets/ai-search-prompt/latest/ai-search-prompt.js
```
...
```html
<script
  src="http://widgets.carous.test/widgets/ai-search-prompt/latest/ai-search-prompt.js"
