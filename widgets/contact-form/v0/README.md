...
```text
/widgets/contact-form/v0/contact-form.js
```

Local test URL:

```text
http://widgets.carous.test/widgets/contact-form/v0/contact-form.js
```
...
<script
  src="http://widgets.carous.test/widgets/contact-form/v0/contact-form.js"
