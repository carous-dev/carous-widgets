...
```text
/widgets/delivery-calculator/latest/delivery-calculator.js
```

Local test URL:

```text
http://widgets.carous.test/widgets/delivery-calculator/latest/delivery-calculator.js
```
...
<script
  src="http://widgets.carous.test/widgets/delivery-calculator/latest/delivery-calculator.js"
