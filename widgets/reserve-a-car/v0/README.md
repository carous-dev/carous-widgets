...
```text
/widgets/reserve-a-car/v0/reserve-a-car.js
```

Local test URL:

```text
http://widgets.carous.test/widgets/reserve-a-car/v0/reserve-a-car.js
```
...
```html
<script
  src="http://widgets.carous.test/widgets/reserve-a-car/v0/reserve-a-car.js"
