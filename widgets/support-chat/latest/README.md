...
```text
/widgets/support-chat/latest/support-chat.js
```

Local test URL:

```text
http://widgets.carous.test/widgets/support-chat/latest/support-chat.js
```
...
```html
<script
  src="http://widgets.carous.test/widgets/support-chat/latest/support-chat.js"
