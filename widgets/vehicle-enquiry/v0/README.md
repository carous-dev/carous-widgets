...
```text
/widgets/vehicle-enquiry/v0/vehicle-enquiry.js
```

Local test URL:

```text
http://widgets.carous.test/widgets/vehicle-enquiry/v0/vehicle-enquiry.js
```
...
```html
<script
  src="http://widgets.carous.test/widgets/vehicle-enquiry/v0/vehicle-enquiry.js"
