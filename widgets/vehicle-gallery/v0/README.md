...
```text
/widgets/vehicle-gallery/v0/vehicle-gallery.js
```

Local test URL:

```text
http://widgets.carous.test/widgets/vehicle-gallery/v0/vehicle-gallery.js
```
...
<script
  src="http://widgets.carous.test/widgets/vehicle-gallery/v0/vehicle-gallery.js"
