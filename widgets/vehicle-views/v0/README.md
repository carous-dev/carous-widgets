...
```text
/widgets/vehicle-views/v0/vehicle-views.js
```

Local test URL:

```text
http://widgets.carous.test/widgets/vehicle-views/v0/vehicle-views.js
```
...
```html
<script
  src="http://widgets.carous.test/widgets/vehicle-views/v0/vehicle-views.js"
