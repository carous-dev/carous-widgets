...
```text
/widgets/visitor-chat/latest/visitor-chat.js
```

Local test URL:

```text
http://widgets.carous.test/widgets/visitor-chat/latest/visitor-chat.js
```
...
```html
<script
  src="http://widgets.carous.test/widgets/visitor-chat/latest/visitor-chat.js"
