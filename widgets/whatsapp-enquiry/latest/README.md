...
```text
/widgets/whatsapp-enquiry/latest/whatsapp-enquiry.js
```

Local test URL:

```text
http://widgets.carous.test/widgets/whatsapp-enquiry/latest/whatsapp-enquiry.js
```
...
```html
<script
  src="http://widgets.carous.test/widgets/whatsapp-enquiry/latest/whatsapp-enquiry.js"
...
- Use a versioned URL such as `/widgets/whatsapp-enquiry/v0/whatsapp-enquiry.js` for stable production rollouts.
- Use `/widgets/whatsapp-enquiry/latest/whatsapp-enquiry.js` only for local testing or controlled preview environments.
